...
void HandleHeaderButtonInteraction(Clay_ElementId elementId, const Clay_PointerData pointerData, void* userData) {
...
void SidebarBlob(const Clay_ElementId clay_element_id) {
